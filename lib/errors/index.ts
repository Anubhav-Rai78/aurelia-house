...
// and API-route error handling across the Aurelia House codebase.
//
// Usage:
//   throw new ConflictError("This room is already booked.");
...
//   throw new DatabaseError("Failed to insert reservation", originalError);
// ──────────────────────────────────────────────────────────────────────────────
